		...
		<div class="s4-content">
			<table class="table-primary search4" style="table-layout: fixed;">
				...
				<tr>
					...
					<td>2011</td>
					<td><img src="<?php echo $config["resourcesDir"]; ?>/images/part/page-sub/btn_lending_okok.gif" alt="대출가능" /></td>
					<td><img src="<?php echo $config["resourcesDir"]; ?>/images/part/page-sub/btn_reservation_okok.gif" alt="예약가능" /></td>
