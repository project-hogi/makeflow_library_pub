...
<div class="tab-index pointer">
	<p>
	<a href="#none" class="tab-index-1">처음으로</a><span>&gt;</span>
	<a href="#none" class="tab-index-2">[000] 총류</a><span>&gt;</span>
	<a href="#none" class="tab-index-3">[123] 도서학</a></p>
</div>
<!-- /.location -->
<div class="tab-menu">
	<ul>
		<li><a href="#none">[000] 총류</a></li>
		<li><a href="#none">[010] 도서학, 서지학</a></li>
		<li><a href="#none">[020] 문헌정보학</a></li>
		<li><a href="#none">[030] 백과사전</a></li>
		<li><a href="#none">[040] 강연집, 수필집, 연설문집</a></li>
		<li><a href="#none">[050] 일반 연속간행물</a></li>
		<li><a href="#none">[060] 일반 학회,단체, 협회, 기관, 연구기관</a></li>
		<li><a href="#none">[070] 신문, 언론, 저널리즘</a></li>
		<li><a href="#none">[080] 일반전집, 총서</a></li>
		<li><a href="#none">[090] 향토자료</a></li>
	</ul>
</div>
<!-- /.tab-menu -->
...
<table class="table-primary search3">
  ...
  <tbody>
    <tr>
      ...
      <td>2011</td>
      <td><img src="/resources-dev/front/images/part/page-sub/btn_lending_okok_1.gif" alt="대출가능" /></td>
      <td><img src="/resources-dev/front/images/part/page-sub/btn_reservation_okok_1.gif" alt="예약가능" /></td>
      <td><img src="/resources-dev/front/images/part/page-sub/book_01.gif" alt="단행본" /></td>
      <td></td>
    </tr>
    <tr>
      <td>2</td>
    ...
    <tr>
      ...
      <td>2007</td>
      <td><img src="/resources-dev/front/images/part/page-sub/btn_lending_nono_1.gif" alt="대출불가" /></td>
      <td><img src="/resources-dev/front/images/part/page-sub/btn_reservation_okok_1.gif" alt="예약가능" /></td>
      <td><img src="/resources-dev/front/images/part/page-sub/book_01.gif" alt="단행본" /></td>
      <td></td>
    </tr>
